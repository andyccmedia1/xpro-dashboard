...
const fmtDate = (d: unknown) => { const dt = new Date(String(d) + 'T00:00:00'); return dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) }
            ...
            <ComposedChart data={series} margin={{ top: 4, right: 16, left: 8, bottom: 0 }}>
              ...
              <Tooltip
                ...
                formatter={(v: unknown, name: unknown) => {
                  ...
                  return s === 'ROAS' ? [n.toFixed(2) + 'x', s] : [(n*100).toFixed(1)+'%', s]
                }}
                labelFormatter={fmtDate}
              />
              <Legend wrapperStyle={{ fontSize: 12, color: '#9ca3af', paddingTop: 12 }} />
